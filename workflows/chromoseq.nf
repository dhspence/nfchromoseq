...
WorkflowChromoseq.initialise(params, log)

// TODO nf-core: Add all file path parameters for the pipeline to the list below
// Check input path parameters to see if they exist
def checkPathParamList = [ params.input, params.outdir, params.multiqc_config, params.fasta ]
...
//    )
    ...
    // MODULE: MultiQC
    //
    workflow_summary    = WorkflowChromoseq.paramsSummaryMultiqc(workflow, summary_params)
    ch_workflow_summary = Channel.value(workflow_summary)

    methods_description    = WorkflowChromoseq.methodsDescriptionText(workflow, ch_multiqc_custom_methods_description)
